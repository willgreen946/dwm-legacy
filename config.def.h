...
static const char red[]		    = "#eb0028";
static const char purple[]          = "#54487a"; 
static const char white[]           = "#ffffff";
static const char yellow[]          = "#f2ca30";
static const char orange[]          = "#f26711";
...
#define WIFISCRIPT "/home/will/.scripts"
#define NTWRK "wlan0"
...
static const Key keys[] = {
	...
	#endif
	{ MODKEY,		XK_s,	  XK_w,	     spawn,	{.v = (const char*[]) {TERMINAL, "bash", "curl", "wttr.in", "&&", "read i", NULL}}},
	...
	{ MODKEY,		XK_w,	  XK_3,	     spawn,	{.v = (const char*[]) {BROWSER,	"wiki.installgentoo.com",	 NULL}}},
	...
	{ MODKEY,		XK_w,	  XK_6,	     spawn,	{.v = (const char*[]) {BROWSER, "bbs.archlinux.org",		 NULL}}},
	{ MODKEY,		XK_w,	  XK_7,	     spawn,	{.v = (const char*[]) {BROWSER,	"openbsd.org",			 NULL}}},
	{ MODKEY,		XK_w,	  XK_8,	     spawn,	{.v = (const char*[]) {BROWSER,	"gnu.org",			 NULL}}},
	{ MODKEY,		XK_w,	  XK_9,	     spawn,	{.v = (const char*[]) {BROWSER, "ebay.co.uk",			 NULL}}},
	...
	{ MODKEY,		XK_w,	  XK_r,      spawn,	{.v = (const char*[]) {BROWSER, "cppreference.com",		 NULL}}},
	{ MODKEY,		XK_w,	  XK_minus,  spawn,	{.v = (const char*[]) {BROWSER, "legacy.cplusplus.com/",	 NULL}}},
	...
	{ MODKEY,		XK_w,	  XK_y,	     spawn,	{.v = (const char*[]) {BROWSER, "vid.puffyan.us",		 NULL}}},
	...
	{ MODKEY,		XK_r,	  XK_j,	     movemouse,	     {.i = -1}},
	{ MODKEY,		XK_r,	  XK_k,	     movemouse,	     {.i = +1}},
